...
public class CoordinateInputScreen extends BaseParentedScreen<Screen> {
   ...
   private void fillCurrentPosition() {
      ...
      if (mc != null && mc.player != null) {
         this.xField.setValue(String.format("%.2f", mc.player.getX()));
         this.yField.setValue(String.format("%.2f", mc.player.getY()));
         this.zField.setValue(String.format("%.2f", mc.player.getZ()));
      }
   }
