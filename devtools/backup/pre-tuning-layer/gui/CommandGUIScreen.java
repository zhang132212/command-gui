...
public class CommandGUIScreen extends Screen {
   ...
   protected void init() {
      ...
      int closeBtnY = this.height - 44 + 12;
      ...
      this.filterOnCheckbox = new MarkCheckbox(
         10, closeBtnY - 8, 112, 14, Component.translatable("screen.command-gui.machine.filter_on"), false, b -> this.toggleMachineFilter(true)
      );
      ...
      this.filterOffCheckbox = new MarkCheckbox(
         10, closeBtnY + 6, 112, 14, Component.translatable("screen.command-gui.machine.filter_off"), false, b -> this.toggleMachineFilter(false)
      );
      ...
      this.fpBatchSpawnButton = Button.builder(
         ...
         .bounds(this.width - 10 - 60 - 4 - 88, closeBtnY, 88, 20)
         .build();
      ...
      this.closeButton = Button.builder(Component.translatable("screen.command-gui.close"), button -> this.onClose())
         .bounds(this.width - 10 - 60, closeBtnY, 60, 20)
         .build();
      ...
      int tabAreaHeight = Math.max(20, this.height - 44 - listTop - 2);
      this.tabArea = new ScreenRectangle(10, listTop, this.width - 10 - 16 - 12, tabAreaHeight);
      ...
      int fpAreaHeight = Math.max(20, this.height - 44 - (tabBarBottom + 4) - 2);
      this.fakePlayerArea = new ScreenRectangle(10, tabBarBottom + 4, this.width - 10 - 16 - 12, fpAreaHeight);
   ...
   private void updateTabDependentWidgets(Tab tab) {
      ...
      if (isFakePlayerTab) {
         ...
         this.machineSaveButton.setY(this.height - 44 + 12);
         ...
         this.addFakePlayerButton.setY(this.height - 44 + 12);
   ...
   public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
      ...
      Tab currentTab = this.tabManager.getCurrentTab();
      int bottomSeparatorY = this.height - 44;
   ...
   private void renderScrollbar(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
      if (this.tabArea != null) {
         ...
         int scrollbarX = !isMachineTab && currentTab != this.customTab ? this.width - 16 - 12 : this.width - 8 - 12;
         int scrollbarTop = this.tabArea.top();
         int scrollbarHeight = this.tabArea.height();
         this.mainScrollbar = new ScrollbarHandle(scrollbarX, scrollbarTop, 12, scrollbarHeight);
   ...
   private void tryStartScrollbarDrag(double mouseX, double mouseY) {
      ...
      if (currentTab instanceof AbstractCommandTab ct && ct.getArea() != null) {
         ...
         ScrollbarHandle catHandle = new ScrollbarHandle(catX, catY, 12, catH);
      ...
      if (currentTab == this.fakePlayerTab) {
         ...
         ScrollbarHandle fpHandle = new ScrollbarHandle(fpScrollX, fpY, 12, fpH);
      ...
      if (currentTab == this.fakePlayerTab && this.fakePlayerTab.getArea() != null) {
         ...
         ScrollbarHandle fpPanelHandle = new ScrollbarHandle(fpPanelX, fpPanelY, 12, fpPanelH);
   ...
   private void applyFakePlayerScrollbarDrag(double mouseY) {
      if (this.fakePlayerTab.getArea() != null && this.fakePlayerTab.getMaxScroll() > 0) {
         ...
         int fpY = this.fakePlayerTab.getArea().top();
         int fpH = this.fakePlayerTab.getArea().height();
         ScrollbarHandle fpHandle = new ScrollbarHandle(fpX, fpY, 12, fpH);
